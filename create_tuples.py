...
"""
Observe: evaluating this process will be easiest
when it is in a .csv format. From there, we can 
try to figure out problems with above code. 
"""
